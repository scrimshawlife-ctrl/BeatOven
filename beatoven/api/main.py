...
async def generate(request: GenerateRequest, background_tasks: BackgroundTasks):
    ...
    try:
        ...
        stems = app.state.stem_generator.generate_stems(
            rhythm_events=rhythm_result.output["pattern"],
            harmonic_events=harmony_result.output["progression"],
            duration=request.duration,
        ...
        return GenerateResponse(
            ...
            rhythm_descriptor=rhythm_result.output["description"],
            harmonic_descriptor=harmony_result.output["description"],
            motion_descriptor=motion_result.output["description"],
